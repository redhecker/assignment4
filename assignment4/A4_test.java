...
public class A4_test {
    public static void main(String[] args) {
        ...
        l3.add(t1);
        l3.add(t3);
        Course CS109_1 = new Course("Max", "Computer_programming", "CS109", 1,
                l1, 1);
        Course CS109_2 = new Course("Turing", "Computer_programming", "CS109", 2,
                l1, 100);
        Course MA101 = new Course("Alice", "Math", "MA101", 1, l2, 80);
        Course MA107 = new Course("Jack", "Linear_algebra", "MA107", 1, l3,
                80);
        ...
        System.out.println(Anya_curriculum.size());
        System.out.println(Jinrun_curriculum.size());
    }
